...
export default function CreateSurveyScreen() {
  ...
  const { admin, createSurvey } = useSuperAdmin();
  ...
  const handleCreateSurvey = async () => {
    if (!admin) {
      Alert.alert("Erreur", "Profil admin introuvable");
      return;
    }
    ...
    try {
      ...
      Alert.alert(
        ...
        [{ text: "OK", onPress: () => router.push("/(super-admin)/surveys" as never) }]
      );
    } catch (error) {
  ...
  const renderPrivacy = () => {
    const privacyOptions: {
      ...
      },
      {
        value: "private",
        label: "Privé",
        description: "Sondage privé pour usage interne",
    ...
    return (
      <View style={styles.stepContent}>
        ...
        <Text style={styles.stepSubtitle}>
          Choisissez qui peut voir ce sondage
        </Text>
        ...
        <View style={styles.adminInfo}>
          <AlertCircle size={20} color={Colors.light.success} />
          <Text style={styles.adminInfoText}>
            En tant que Super Admin, vous pouvez créer des sondages gratuitement.
          </Text>
        </View>
  ...
  const renderReview = () => (
    <View style={styles.stepContent}>
      ...
      <View style={styles.reviewCard}>
        ...
        <View style={styles.reviewRow}>
          <Text style={styles.reviewLabel}>Créé par:</Text>
